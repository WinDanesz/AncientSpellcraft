...
public class BiomePocket extends Biome {
	 ...
	 */
	public BiomePocket() {
		super(new BiomeProperties(AncientSpellcraftDimensions.POCKET_DIM_NAME)
				.setRainDisabled()
				.setWaterColor(Color.CYAN.getRGB())
				.setTemperature(0.2f)
				.setBaseHeight(1F)
		);
		this.setRegistryName(new ResourceLocation(AncientSpellcraft.MODID, AncientSpellcraftDimensions.POCKET_DIM_NAME));
