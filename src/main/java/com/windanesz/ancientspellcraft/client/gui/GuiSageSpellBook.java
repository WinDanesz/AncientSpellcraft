...
public class GuiSageSpellBook extends GuiSpellInfo {
	...
	public GuiSageSpellBook(ItemStack stack) {
		super(288, 180);
	...
	protected void drawForegroundLayer(int left, int top, int mouseX, int mouseY) {
		...
		String element = I18n.format("gui.ebwizardry:spell_book.element", TextFormatting.GOLD + I18n.format("gui.ancientspellcraft:element.sage"));
		if (!discovered)
