...
import com.windanesz.ancientspellcraft.client.renderer.entity.RenderSpellBook;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderers() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityTransportationPortal.class,
				manager -> new RenderSigil(manager, new ResourceLocation(AncientSpellcraft.MODID, "textures/entity/transportation_portal.png"), 3.0f, false));

		RenderingRegistry.registerEntityRenderingHandler(EntitySpiritWard.class,
				manager -> new RenderSigil(manager, new ResourceLocation(AncientSpellcraft.MODID, "textures/entity/spirit_ward.png"), 6.0f, false));

		RenderingRegistry.registerEntityRenderingHandler(EntitySilencingSigil.class,
				manager -> new RenderSigil(manager, new ResourceLocation(AncientSpellcraft.MODID, "textures/entity/silencing_sigil.png"), 1.0f, false));
