...
public class RenderSpectralFishHook extends Render<EntityFishHook>
{
    private static final ResourceLocation FISH_PARTICLES = new ResourceLocation("textures/particle/particles.png");

    public RenderSpectralFishHook(RenderManager renderManagerIn)
    {
    ...
    public void doRender(EntityFishHook entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entityplayer != null && !this.renderOutlines)
        {
            ...
            for (int i1 = 0; i1 <= 16; ++i1)
            {
                ...
                bufferbuilder.pos(x + d10 * (double)f11, y + d11 * (double)(f11 * f11 + f11) * 0.5D + 0.25D, z + d12 * (double)f11).color(253, 0, 0, 255).endVertex();
            }
