...
public class RenderMoltenBoulder extends RenderBoulder {

	private static final ResourceLocation TEXTURE = new ResourceLocation(AncientSpellcraft.MODID, "textures/entity/molten_boulder.png");

	private ModelBoulder model = new ModelBoulder();

	public RenderMoltenBoulder(RenderManager manager) {
		super(manager);
	}
