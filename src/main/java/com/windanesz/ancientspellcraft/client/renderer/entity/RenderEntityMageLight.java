...
// adapted from RenderProjectile
public class RenderEntityMageLight extends Render<EntityMageLight> {
	private float scale;
	private boolean blend = false;

	private final ResourceLocation texture;

	public RenderEntityMageLight(RenderManager renderManager, float scale, ResourceLocation texture, boolean doBlending) {
		super(renderManager);
		this.scale = scale;
	...
	@Override
	public void doRender(EntityMageLight entity, double par2, double par4, double par6, float par8, float par9) {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityMageLight entity) {
		return texture;
	}
}
