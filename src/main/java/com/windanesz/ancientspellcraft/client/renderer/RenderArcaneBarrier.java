...
public class RenderArcaneBarrier { // extends Render<EntityArcaneBarrier> {

//	private static final float EXPANSION_TIME = 3;
//
//	public RenderArcaneBarrier(RenderManager renderManager){
//		super(renderManager);
//	}
//
//	@Override
//	public void doRender(EntityArcaneBarrier entity, double x, double y, double z, float yaw, float partialTicks){
...
//
//	@Override
//	protected ResourceLocation getEntityTexture(EntityArcaneBarrier entity){
//		return null;
//	}
//
//	/**
