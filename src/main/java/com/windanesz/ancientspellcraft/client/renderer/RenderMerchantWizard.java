...
import com.windanesz.ancientspellcraft.client.layer.LayerBackpack;
...
public class RenderMerchantWizard extends RenderBiped<EntityWizard> {

	static final ResourceLocation[] TEXTURES = new ResourceLocation[6];

	public RenderMerchantWizard(RenderManager renderManager){
		...
		this.addLayer(new LayerBackpack(this));
	}
