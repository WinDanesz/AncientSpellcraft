...
public class RenderWisp extends Render<EntityWisp> {
	...
	public RenderWisp(RenderManager renderManager, float scale, ResourceLocation texture, boolean doBlending) {
		super(renderManager);
		this.scale = scale;
	...
	@Override
	public void doRender(EntityWisp entity, double par2, double par4, double par6, float par8, float par9) {
