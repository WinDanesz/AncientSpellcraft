...
public class CurseEnder extends Curse {

	public CurseEnder(boolean isBadEffect, int liquiidColour) {
		super(isBadEffect, liquiidColour, new ResourceLocation(AncientSpellcraft.MODID, "textures/gui/potion_icon_curse_of_ender.png"));
