...
public class EssenceRegenerationPotionRecipe implements IBrewingRecipe {
	...
	public EssenceRegenerationPotionRecipe() {}
	...
	public boolean isInput(@Nonnull ItemStack stack) {
		return PotionUtils.getPotionFromItem(stack) == PotionTypes.HEALING;
	}
	...
	public ItemStack getOutput(@Nonnull ItemStack input, @Nonnull ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient))
			return PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.REGENERATION);
