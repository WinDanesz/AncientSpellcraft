...
/** Made by Electroblob, modified by WinDanesz for artefact effect */
public class Grapple extends Spell {
	...
	public Grapple(){
		super(AncientSpellcraft .MODID, "grapple", SpellActions.GRAPPLE, true);
	...
	public boolean cast(World world, EntityPlayer caster, EnumHand hand, int ticksInUse, SpellModifiers modifiers){
		...
		if(extending){
			...
			if(world.isRemote){
				...
				ParticleBuilder.create(Type.VINE).entity(caster).pos(0, caster.getEyeHeight() - Y_OFFSET, 0)
