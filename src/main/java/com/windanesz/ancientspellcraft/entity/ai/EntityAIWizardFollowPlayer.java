 ...
 */
public class EntityAIWizardFollowPlayer extends EntityAIBase {
	...
	public EntityAIWizardFollowPlayer(EntityWizard summonedCreature, double followSpeedIn, float minDistIn, float maxDistIn, EntityPlayer playerToFollow) {
