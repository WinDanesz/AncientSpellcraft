...
public class EntityPigZombieMinion extends EntityPigZombie implements ISummonedCreature {

	private static final DataParameter<Boolean> SPAWN_PARTICLES = EntityDataManager.createKey(EntityPigZombieMinion.class, DataSerializers.BOOLEAN);

	// Field implementations
	private int lifetime = -1;
	private UUID casterUUID;

	public EntityPigZombieMinion(World world) {
		super(world);
	...
	@Override
	public void setChild(boolean childZombie) {} // Can't be a child
	...
	@Override
	protected ItemStack getSkullDrop() { return ItemStack.EMPTY; }
