...
public final class ASSpells {
	...
	public static final Spell curse_of_eternal_tempest = placeholder();
	...
	public static final Spell will_o_wisp = placeholder();	public static final Spell natures_sprout = placeholder();
	public static final Spell create_igloo = placeholder();
	public static final Spell ice_tower = placeholder();
	public static final Spell ice_workbench = placeholder();	public static final Spell snow_block = placeholder();
	public static final Spell arcane_flame = placeholder();
	public static final Spell enchant_fireplace = placeholder();
	public static final Spell wildfire_flame = placeholder();
...
//    public static final Spell absorb_armor = placeholder();
	...
	public static void register(RegistryEvent.Register<Spell> event) {
		...
		registry.register(new CurseOfEternalTempest());
