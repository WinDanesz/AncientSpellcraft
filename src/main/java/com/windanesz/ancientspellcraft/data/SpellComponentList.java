...
public enum SpellComponentList {
	...
	SUMMON_REMNANT(ASSpells.summon_remnant, new ItemStack(WizardryItems.spectral_dust), new ItemStack(Item.getItemFromBlock(WizardryBlocks.runestone)), new ItemStack(WizardryItems.grand_crystal));
